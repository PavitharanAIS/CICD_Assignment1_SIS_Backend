...
SECRET_KEY = 'django-insecure-0x)&4vb-)_eh_#^nqb@1!+7l^b5-@vdb3nnj^(yq3-6m=sn3ia'
...
DATABASES = {
    "default": {
        ...
        "PASSWORD": os.environ.get('DB_PASSWORD', 'zuUo4Xtqy5nI'),
        "HOST": os.environ.get('DB_HOST', 'ep-bold-cloud-a70ec02k.ap-southeast-2.aws.neon.tech'),
